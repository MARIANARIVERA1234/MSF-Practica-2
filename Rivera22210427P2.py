...
#Funcion de tranferencia: individuo enfero [caso]
RP, CL = 7.5, 0.4
...
def plotsignals(u, sysS, sysE, sysPID, signal):
    ...
    plt.plot(t,pid, ':', linewidth = 3, color = [126/255, 24/255, 145/255], label = '$PA(t): Tratamiento$')
    plt.grid(False)
    plt.xlim(0, 30)
    plt.ylim(-3, 3)
...
kP, kI, kD, Cr = 200.523, 3760.859, 1.001, 1E-6
Re = 1/(kI*Cr)
Rr = kP*Re
Ce = kD/Rr
